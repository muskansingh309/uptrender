      ...
      <div className="w-full max-w-[1860px] mx-auto px-[15px] sm:px-[20px] lg:px-[30px] flex items-center justify-between">
        ...
        <div className="flex-shrink-0">
          <a href="/" className="flex items-center gap-2">
            <div className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 bg-gray-800 rounded-lg lg:rounded-xl flex items-center justify-center shadow-lg">
        ...
        <div className="hidden lg:flex items-center space-x-[30px]">
          {/* Centered Nav Box - White Theme */}
          <div className="bg-white/95 backdrop-blur-sm shadow-lg rounded-[24px] px-10 py-3.5 border border-gray-200/50">
            <ul className="flex items-center list-none m-0 p-0 gap-10">
              {navLinks.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className={`text-[14px] font-semibold tracking-wide transition-all duration-200 ${
          ...
          <div className="flex items-center space-x-[25px] ml-[20px]">
            ...
            <a
              href="/signin"
              className="inline-flex items-center justify-center px-5 py-2 border-2 border-gray-300 text-gray-700 text-[12px] font-semibold uppercase tracking-wider rounded-[10px] hover:bg-gray-100 hover:border-gray-400 transition-all duration-300"
            >
              Sign In
            </a>
          </div>
